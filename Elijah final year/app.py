...
if database_url:
    # Safely convert standard Render/Heroku postgres:// strings to postgresql://
...
# --- FIXED BOOTSTRAP BLOCK ---
if __name__ == '__main__':
    import os
    
    # Secure context runtime to make sure tables generate instantly inside Supabase
