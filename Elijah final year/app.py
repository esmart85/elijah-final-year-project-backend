...
database_url = os.environ.get('postgresql://hidden:[YOUR-PASSWORD]@hidden:5432//postgres:[Huntuathebighead@2004]@db.ktvagrhteattxxliwgop.supabase.co:5432/postgres')
